...
<section class="content">
    ...
    <div class="box">
      @include('admin.messages_error')
        <div class="box-body">
            <form name="frmAdd" method="post" action="{!! route('admin.banggia.postEdit', $data->id) !!}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group col-md-12 @if ($errors->first('fImages')!='') has-error @endif">
                                      <label for="file">File tài liệu</label>
                                        <p><a href="{{asset('upload/document/'.$data->document)}}" title="">{{asset('upload/document/'.$data->document)}}</a></p>

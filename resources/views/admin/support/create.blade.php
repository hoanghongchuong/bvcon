...
<section class="content">
    ...
    <div class="box">
      @include('admin.messages_error')
        <div class="box-body">
            <form name="frmAdd" method="post" action="{!! route('admin.support.postCreate') !!}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="" name="phone" value=""  class="form-control" />
                                    </div>
                                    <div class="form-group">
                                        <label for="desc">Mô tả</label>
                                        <input type="text" name="mota_vi" value="" class="form-control" placeholder="">
                        ...
                        <div class="tab-pane " id="tab_2">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="desc">Mô tả</label>
                                        <input type="text" name="mota_en" value="" class="form-control" placeholder="">                                        
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="">                                        
                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <button type="button" onclick="javascript:window.location='backend/support'" class="btn btn-danger">Thoát</button>
                        </div>
                    </div>
                </div>
            </form>           
